...
[![ForTheBadge built-with-love](https://ForTheBadge.com/images/badges/built-with-love.svg)](https://GitHub.com/mebularts/)
...
2. **Uygulamanın yüklü olduğu cihazda** _[depoyu otomatik yüklemek için tıklayın](https://raw.githubusercontent.com/mebularts/CloudstreamTR/master/repo.json)_
   - **veya**
   - `Depo ekle` _butonuyla **manuel** ekleme yapmak isteyen arkadaşlar için_ `mebularts` _**kısa kod**u mevcuttur._ `Depo ismi` _kısmını boş bırakarak_ `Depo URL'si` _kısmına_ `mebularts` yazarak `Depo ekle` _demeniz yeterli.._

## 📼 Video Anlatım

[![Video](https://github.com/mebularts/CloudstreamTR/raw/master/.github/icons/depourl.png?raw=True)](https://www.youtube.com/watch?v=giht5QSPbOE)
...
[![Repo](https://github.com/mebularts/CloudstreamTR/raw/master/.github/icons/Repo.jpg?raw=True)](https://raw.githubusercontent.com/mebularts/CloudstreamTR/master/repo.json)
...
* *Copyright (C) 2023 by* [mebularts](https://github.com/mebularts) ❤️️
* [GNU GENERAL PUBLIC LICENSE Version 3, 29 June 2007](https://github.com/mebularts/CloudstreamTR/blob/master/LICENSE) *Koşullarına göre lisanslanmıştır..*

## ♻️ İletişim

*Bizimle iletişime geçmek isterseniz, **Telegram**'dan mesaj göndermekten çekinmeyin;* [@mebularts](https://t.me/mebularts)

***

> **[@mebularts](https://instagram.com/mebularts)** *için KekikAkademi'den dızlanmıştır..*
